...
- Mac 工作区只编写代码，不执行测试、构建、Docker 或浏览器验证。
...
验收会检查 Linux/AMD64、Tailscale、Docker、Node 24、Flutter、Chrome、唯一 RTX 5090，
随后执行上游联网校验、合同/单元测试、双节点 Room/Data/RPC/音频测试，以及真实 Chrome
中的 Web/Flutter Web 兼容测试。运行报告写到被 Git 忽略的 `outputs/beelink/`。
