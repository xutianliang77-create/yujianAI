...
PostgreSQL/Redis/OpenBao 部署切片、runtime module、事务 outbox/CAS、分布式 quota 竞争和
API key/KMS production acceptance 已有脱敏证据；仍缺注册/邀请/SSO/RBAC、真实 webhook、
跨主机 HA、备份恢复、数据权利执行和 owner 签字。
