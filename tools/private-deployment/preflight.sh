...
for migration in 001_platform.sql 002_domain_expansion.sql 003_agent_control.sql 004_media_ops.sql 005_outbox_delivery.sql 006_platform_store.sql 007_webhook_destinations.sql 008_rtc_telemetry.sql; do
